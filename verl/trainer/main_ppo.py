...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, is_train=True, max_samples: int = -1):
    ...
    from verl.utils.dataset.rl_dataset import RLHFDataset, SelfVerifyRLDataset
    ...
    if "custom_cls" in data_config and data_config.custom_cls.get("path", None) is not None:
        ...
        if data_config.get("use_self_verify", False):
            dataset_cls = SelfVerifyRLDataset
            print("Using SelfVerifyRLDataset for explicit/implicit intent handling.")
